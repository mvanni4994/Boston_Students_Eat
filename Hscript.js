...
function takeout() {
    let input = $("#input").val()
    var queryUrl = "https://cors-anywhere.herokuapp.com/https://developers.zomato.com/api/v2.1/search?entity_id=6011&entity_type=landmark&q=" + input + "&lat=71.1167&lon=42.3770&radius=4828.03";
    console.log(input)
