...
function takeout() {
    let input = $("#input").val()
    var queryUrl = "https://cors-anywhere.herokuapp.com/https://developers.zomato.com/api/v2.1/search?entity_id=114442&entity_type=subzone&q=" + input + "&lat=71.1167&lon=42.3770&radius=16093.4";
    console.log(input)
    ...
    .then(function(response){
        ...
        function restaurantInfo (){
            var queryUrl2 = "https://cors-anywhere.herokuapp.com/https://developers.zomato.com/api/v2.1/search?entity_id=114442&entity_type=subzone&q=" + input + "&lat=71.1167&lon=42.3770&radius=16093.4";
